    ...
    <div className="home-container">
      <header className="hero-section">
        <div className="hero-text animate-fade-in">
          ...
          <button className="cta-button animate-pulse" onClick={() => navigate("/upload")}>Get Started</button>
        </div>
      </header>
      ...
      <section className="features">
        ...
        <div className="feature animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="feature animate-fade-in" style={{ animationDelay: '0.4s' }}>
      ...
      <section className="about-platform animate-fade-in">
